...
function getSummaryPrompt(transcript) {
  return `Title: "${document.title
    .replace(/\n+/g, " ")
    .trim()}"\nTranscription de la vidéo: "${truncateTranscript(transcript)
    .replace(/\n+/g, " ")
    .trim()}"\nRésume moi cette transcription et donne moi les points clés:`;
}
...
/***/ "./src/contentscript/searchParam.js":
/*!******************************************!*\
  !*** ./src/contentscript/searchParam.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/contentscript/transcript.js":
/*!*****************************************!*\
  !*** ./src/contentscript/transcript.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getLangOptionsWithLink": () => (/* binding */ getLangOptionsWithLink),
/* harmony export */   "getRawTranscript": () => (/* binding */ getRawTranscript),
/* harmony export */   "getTranscript": () => (/* binding */ getTranscript),
/* harmony export */   "getTranscriptHTML": () => (/* binding */ getTranscriptHTML)
/* harmony export */ });
...
async function getRawTranscript(link) {
  ...
  // Parse Transcript
  const jQueryParse = jquery__WEBPACK_IMPORTED_MODULE_0___default().parseHTML(transcriptPageXml);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "insertSummaryBtn": () => (/* binding */ insertSummaryBtn)
/* harmony export */ });
/* harmony import */ var _transcript__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./transcript */ "./src/contentscript/transcript.js");
/* harmony import */ var _searchParam__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./searchParam */ "./src/contentscript/searchParam.js");
/* harmony import */ var _prompt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prompt */ "./src/contentscript/prompt.js");
/* harmony import */ var _copy__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./copy */ "./src/contentscript/copy.js");
...
function insertSummaryBtn() {
    ...
    if (!(0,_searchParam__WEBPACK_IMPORTED_MODULE_1__.getSearchParam)(window.location.href).v) { return; }
    ...
    waitForElm('#secondary.style-scope.ytd-watch-flexy').then(() => {
        ...
        <div class="yt_ai_summary_container">
            <div id="yt_ai_summary_header" class="yt_ai_summary_header">
                <a href="https://github.com/Zealest/quickrecap-ai" target="_blank" style="width: 24px;height: 24px;">
                    <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.40123 27.3686C-0.44103 25.5284 -0.441033 22.5449 1.4012 20.7047L16.5971 5.52573L24.0098 12.9301L5.47818 31.4409L1.40123 27.3686Z" fill="#FF7575"/>
                        <path d="M35.1286 24.0367L16.5972 5.5258L20.6741 1.45341C22.5164 -0.386772 25.5033 -0.386775 27.3455 1.45341L42.5415 16.6323L35.1286 24.0367Z" fill="#70BFFF"/>
                        <path d="M24.0099 35.143L42.5416 16.6323L46.6183 20.7046C48.4606 22.5448 48.4606 25.5284 46.6183 27.3686L31.4224 42.5476L24.0099 35.143Z" fill="#FF7575"/>
                        <path d="M27.3454 46.6198C25.5032 48.4601 22.5163 48.4601 20.674 46.6198L5.47815 31.4409L12.8908 24.0366L31.4223 42.5476L27.3454 46.6198Z" fill="#70BFFF"/>
                    </svg>
                </a>
                <p class="yt_ai_summary_header_text">Transcription de la vidéo</p>
                <div class="yt_ai_summary_header_actions">
                    <div id="yt_ai_summary_header_summary" class="yt_ai_summary_header_action_btn yt-summary-hover-el yt_ai_summary_icon" data-hover-label="Voir le résumé (AI)\n(Cliquer → Cmd + V)">
                    ...
                    <div id="yt_ai_summary_header_track" class="yt_ai_summary_header_action_btn yt-summary-hover-el" data-hover-label="Aller au timecode">
                    ...
                    <div id="yt_ai_summary_header_copy" class="yt_ai_summary_header_action_btn yt-summary-hover-el" data-hover-label="Copier la transcription">
        ...
        document.querySelector("#yt_ai_summary_header_copy").addEventListener("click", (e) => {
            e.stopPropagation();
            const videoId = (0,_searchParam__WEBPACK_IMPORTED_MODULE_1__.getSearchParam)(window.location.href).v;
        ...
        document.querySelector("#yt_ai_summary_header").addEventListener("click", async (e) => {
            ...
            const langOptionsWithLink = await (0,_transcript__WEBPACK_IMPORTED_MODULE_0__.getLangOptionsWithLink)(videoId);
            ...
            const transcriptHTML = await (0,_transcript__WEBPACK_IMPORTED_MODULE_0__.getTranscriptHTML)(langOptionsWithLink[0].link, videoId);
...
function evtListenerOnLangBtns(langOptionsWithLink, videoId) {
    Array.from(document.getElementsByClassName("yt_ai_summary_lang")).forEach((langBtn) => {
        langBtn.addEventListener("click", async (e) => {
            ...
            const transcriptHTML = await (0,_transcript__WEBPACK_IMPORTED_MODULE_0__.getTranscriptHTML)(link, videoId);
            document.querySelector("#yt_ai_summary_text").innerHTML = transcriptHTML;
            evtListenerOnTimestamp()
...
function copyTranscript(videoId) {
    ...
    ;(0,_copy__WEBPACK_IMPORTED_MODULE_3__.copyTextToClipboard)(contentBody);
}
...
function copyTranscriptAndPrompt() {
    ...
    const prompt = (0,_prompt__WEBPACK_IMPORTED_MODULE_2__.getSummaryPrompt)(text);
    (0,_copy__WEBPACK_IMPORTED_MODULE_3__.copyTextToClipboard)(prompt);
}
...
/*!**************************************!*\
  ...
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _youtube__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./youtube */ "./src/contentscript/youtube.js");
...
window.onload = async () => {
    ...
    if (window.location.hostname === "www.youtube.com") {
        ...
        if (window.location.search !== "" && window.location.search.includes("v=")) {
            (0,_youtube__WEBPACK_IMPORTED_MODULE_0__.insertSummaryBtn)();
        }
